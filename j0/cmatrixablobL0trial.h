...
if (VTable[it->first].loop[i]==i+1 || VTable[it->first].loop[i]==-(i+1)){
	if(VTable[it->first].loop[i]<=0 || VTable[it->first].loop[i+1]<=0)
		{
		WTable[it->first].vectcomp=WTable[it->first].vectcomp+x1*VTable[it->first].vectcomp;
		//WTable[it->first].loop=VTable[it->first].loop;
		...
		WTable[z].vectcomp=WTable[z].vectcomp+loopweightblob*VTable[it->first].vectcomp;
		//WTable[z].loop=z;
		}		
	else
		{
		WTable[it->first].vectcomp=WTable[it->first].vectcomp+x1*VTable[it->first].vectcomp+loopweight*VTable[it->first].vectcomp;
		//WTable[it->first].loop=VTable[it->first].loop;
		}
...
{
WTable[it->first].vectcomp=WTable[it->first].vectcomp+x2*VTable[it->first].vectcomp;
//WTable[it->first].loop=VTable[it->first].loop;
...
WTable[z].vectcomp=WTable[z].vectcomp+VTable[it->first].vectcomp;
//WTable[z].loop=z;
}
...
{									//
									//
VTable[it->first].vectcomp=WTable[it->first].vectcomp;			//Sets V=W
									//
}									//
